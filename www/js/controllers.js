spiredeck.controller('AppCtrl', function($scope, $cordovaPush, ionPlatform, $http, gcm_id) {
...
.controller('DecksCtrl', function($scope) {
	$scope.decks = [
	{ title: 'Ultimate Destruction', id: 1 },
	{ title: 'Fluffy Rabbit', id: 2 },
	{ title: 'Blue Overload', id: 3 },
	{ title: 'The Myths of Kha', id: 4 },
	{ title: 'Sliver Deck', id: 5 },
	{ title: 'Moo twice', id: 6 }
	];
})
